    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200">
        ...
        <p className="text-3xl font-bold text-blue-600">
          ...
          <span className="text-base text-gray-600 font-normal">/{plan.recurring?.interval}</span>
        </p>
        {plan.product?.description && (
          <p className="text-sm text-gray-600 mt-2">{plan.product.description}</p>
        )}
      </div>
      ...
      <div className="max-w-xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Complete Your Subscription</h1>
            <p className="text-gray-600 text-sm mt-2">Enter your payment details below</p>
          </div>
