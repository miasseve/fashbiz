...
const TransactionHistoryTable = ({ transactions }) => {
  ...
  const downloadCSV = () => {
    ...
    const rows = filteredTransactions.map((t) => [
      ...
      t.channel === "shopify" ? "Web (leStoresweb)" : "Store (leStores AI)",
      t.status,
      t.paymentMethod || "",
  ...
  const tabs = [
    ...
    { key: "shopify", label: "Web (leStoresweb)", count: counts.shopify },
    { key: "ree", label: "Store (leStores AI)", count: counts.ree },
  ];
                ...
                {paginatedTransactions.map((tx) => (
                  <TableRow key={tx._id}>
                    ...
                    <TableCell>
                      ...
                      >
                        {tx.channel === "shopify" ? "leStoresweb" : "Store"}
                      </span>
                    </TableCell>
                    <TableCell>
                      <span
              ...
              <ModalBody>
                <div className="space-y-3">
                  ...
                  {selectedTransaction?.shopifyOrderUrl && (
                    ...
                    >
                      View on leStoresweb <FiExternalLink size={14} />
                    </a>
                  )}
