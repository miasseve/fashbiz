...
const SoldTable = ({ products }) => {
  ...
  const downloadCSV = () => {
    ...
    const rows = localProducts.map((p) => [
      ...
      `"${p.title}"`,
      p.price,
      p.soldVia === "shopify" ? "leStoresweb" : "leStores AI",
          ...
          {localProducts.map((product) => (
            <TableRow key={product._id}>
              ...
              <TableCell>
                ...
                >
                  {product.soldVia === "shopify" ? "leStoresweb" : "leStores AI"}
                </span>
              </TableCell>
              ...
              <ModalBody>
                <div className="space-y-5">
                  ...
                  {selectedOrder?.orderDetails?.shopifyOrderUrl && (
                    ...
                    >
                      View on leStoresweb <FiExternalLink size={16} />
                    </a>
                  )}
                </div>
              </ModalBody>
